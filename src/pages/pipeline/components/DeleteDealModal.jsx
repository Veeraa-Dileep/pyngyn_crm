...
const DeleteDealModal = ({ isOpen, onClose, onConfirm, dealTitle, dealEmail }) => {
    // Close on Escape key
    useEffect(() => {
        const onKey = (e) => {
        ...
        >
            ...
            >
                <div className="flex items-center space-x-3 mb-4">
                    ...
                    <div>
                        <h2 className="text-lg font-bold text-foreground">Move to Recycle Bin?</h2>
